# Jiahao Tian's Personal Website
...
* `index.qmd`: The main homepage (About me, Research Interests, Experience).
* `Projects/`: Detailed pages for research projects (e.g., Knockoff aggregation, Conformal Prediction).
* `Talks/`: Detailed information regarding academic presentations.
